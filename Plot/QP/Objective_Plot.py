...
# pFolder = "/home/deb/Documents/gitFIPOPT/Data/QP/Trajectory/"
pFolder = "/home/deb/Documents/gitFIPOPT/Data/QP/Trajectory/"
...
if __name__ == '__main__':
    ...
    ax.plot(f_vals[:,1], color='k', label=r"$f_{SOC}(x_k^{(j)})$")
    ax.plot(f_vals[:,0], color='k', linestyle='dashed', label=r"$E_{\mu_j}(x_k^{(j)})$")
    # ax.plot(theta, color='k', linestyle='dashed', label=r"$\theta(x_k^{(j)})$")
